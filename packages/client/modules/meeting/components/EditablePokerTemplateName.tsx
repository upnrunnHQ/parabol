...
import RenamePokerTemplateMutation from '../../../mutations/RenamePokerTemplateMutation'
import withMutationProps, {WithMutationProps} from '../../../utils/relay/withMutationProps'
import Legitity from '../../../validation/Legitity'
import {EditablePokerTemplateName_teamTemplates} from '../../../__generated__/EditablePokerTemplateName_teamTemplates.graphql'

interface Props extends WithAtmosphereProps, WithMutationProps {
  name: string
  templateId: string
  teamTemplates: EditablePokerTemplateName_teamTemplates
  isOwner: boolean
}
...
class EditablePokerTemplateName extends Component<Props> {
  handleSubmit = (rawName) => {
    ...
    if (error) return
    submitMutation()
    RenamePokerTemplateMutation(atmosphere, {templateId, name}, {}, onError, onCompleted)
  }
